...
namespace DMTec.TestUIFramework.BasicControls
{
    ...
    /// 
    /// </summary>
    public partial class FlexChamberUnit : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        public FlexChamberUnit(int chamberNo)//
        {
            InitializeComponent();
        ...
        public FlexChamberUnit(ChamberConfig config)//
        {
            InitializeComponent();
