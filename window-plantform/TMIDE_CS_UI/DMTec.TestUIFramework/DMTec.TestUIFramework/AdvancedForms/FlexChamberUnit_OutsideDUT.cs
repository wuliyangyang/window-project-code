...
namespace DMTec.TestUIFramework.BasicControls
{
    ...
    /// 
    /// </summary>
    public partial class FlexChamberUnit_OutsideDUT : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        /// Constructor.
        /// </summary>
        public FlexChamberUnit_OutsideDUT()
        {
            InitializeComponent();
        ...
        public FlexChamberUnit_OutsideDUT(int chamberNo)//
        {
            InitializeComponent();
        ...
        public FlexChamberUnit_OutsideDUT(ChamberConfig config)//
        {
            InitializeComponent();
