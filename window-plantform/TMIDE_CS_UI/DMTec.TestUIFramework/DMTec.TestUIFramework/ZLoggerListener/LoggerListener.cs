...
namespace DMTec.TestUIFramework
{
    ...
    public class LoggerListener : ISubscriberUser
    {
        ...
        public event MsgPostHandler   event_LoggerMessage;//All msg show...
        public event LoggerEndHandler event_LoggerEnd;
        public event MsgPostHandler   event_LogInfo;//Output Msg String To UI By Binding This Event.
        public event MsgPostHandler   event_LogError;//Error
        public event MsgPostHandler   event_LogWarn;//Warn
        public event MsgPostHandler event_MtcpConnectError;

        protected virtual void InitMembers()
        {
            this.IsOriginalMsgOutput = false;
            //this.MessageFilter = Globals.PUB_CHANNEL;
        ...
        protected virtual void LogInfo(string msg)
        {
            ...
            if (event_LogInfo != null)
            {
                event_LogInfo.Invoke(this, msgStr);
            }
        }
        ...
        protected virtual void LogWarn(string warnInfo)
        {
            ...
            if (null != event_LogWarn)
            {
                event_LogWarn.Invoke(this, msgStr);
            }
        }
        ...
        protected virtual void LogError(string errorInfo)
        {
            ...
            if(null != event_LogError)
            {
                event_LogError.Invoke(this, msgStr);
            }
        }

        protected virtual void MtcpWarn(string warnInfo)
        {
            if (null != event_MtcpConnectError)
            {
                event_MtcpConnectError.Invoke(this, warnInfo);
            }
        }
        ...
        {
            if (event_LoggerEnd != null)
            {
                try
                {
                    event_LoggerEnd.Invoke(this, e);
                }
                catch (Exception ex)
                {
        ...
        protected virtual void CallLoggerOriginalMsgHandler(string om)
        {
            ...
            if (event_LoggerMessage != null)
            {
                try
                {
                    event_LoggerMessage.Invoke(this, om);//event_AllMsgRcv.BeginInvoke(this, e, null, null);
                }
                catch(Exception ex)
                {
        ...
        protected virtual void ParseLoggerMessage(string msg)
        {
            try
            {
                ...
                msgFrames = Regex.Split(msg, Globals.TM_MSG_SEP);
