...
namespace DMTec.TestUIFramework.AdvancedControls
{
    public partial class Tester : Component
    {
        ...
        /// </summary>
        public TestErrorHandler event_2ALC_PopupError;

        /// <summary>
        /// For ALC Binding To Display Sequencer Msg.
        /// </summary>
        public TestInfoHandler event_2ALC_SequencerMsg;

        /// <summary>
        /// For ALC Binding To Display UI Msg.
        /// </summary>
        public TMListener.MsgHandler event_2ALC_UIMsg;

        /// <summary>
        /// For ALC Binding To Get Test End Result Info.
        /// </summary>
        public TestResultHandler event_2ALC_TestResult;

        /// <summary>
        /// For ALC Binding To Notify Chamber Enable Changed.
        /// </summary>
        public ChamberEnableHandler event_2ALC_ChamberEnableChanged;
        ...
        private void BindSeqEvent1()
        {
            ...
            //mySeqListener1.event_AttributeFound += AttributeFoundHandle_C1;
            //mySeqListener1.event_SeqStart    += SeqStartHandle_C1;           
            mySeqListener1.event_SeqEnd += SeqEndHandle_C1;
            //mySeqListener1.event_ItemStart   += ItemStartHandle_C1;        
            //mySeqListener1.event_ItemEnd     += ItemEndHandle_C1;        
            //mySeqListener1.event_SeqHeartBeat   += HeartbeatHandle_C1;       
            //mySeqListener1.event_SeqReportError += ReportErrorHandle_C1;
        ...
        private void UnbindSeqEvent1()
        {
            ...
            //mySeqListener1.event_SeqAttrFound -= AttributeFoundHandle_C1;
            //mySeqListener1.event_SeqStart -= SeqStartHandle_C1;
            mySeqListener1.event_SeqEnd -= SeqEndHandle_C1;
            //mySeqListener1.event_ItemStart -= ItemStartHandle_C1;
            //mySeqListener1.event_ItemEnd -= ItemEndHandle_C1;
        ...
        private void BindSeqEvent2()
        {
            ...
            //mySeqListener2.event_AttributeFound += AttributeFoundHandle_C2;
            //mySeqListener2.event_SeqStart    += SeqStartHandle_C2;   
            mySeqListener2.event_SeqEnd += SeqEndHandle_C2;
            //mySeqListener2.event_ItemStart   += ItemStartHandle_C2;
            //mySeqListener2.event_ItemEnd     += ItemEndHandle_C2;
            //mySeqListener2.event_SeqHeartBeat   += HeartbeatHandle_C2;
            //mySeqListener2.event_SeqReportError += ReportErrorHandle_C2;
        ...
        private void UnbindSeqEvent2()
        {
            ...
            //mySeqListener2.event_SeqAttrFound -= AttributeFoundHandle_C2;
            //mySeqListener2.event_SeqStart    -= SeqStartHandle_C2;
            mySeqListener2.event_SeqEnd -= SeqEndHandle_C2;
            //mySeqListener2.event_ItemStart   -= ItemStartHandle_C2;
            //mySeqListener2.event_ItemEnd     -= ItemEndHandle_C2;
        ...
        public int StartSeqListener(int chamberNo)
        {
            if (1 == chamberNo)
            {
                ...
                int rst =  mySeqListener1.StartListen(address);
            ...
            else if(2 == chamberNo)
            {
                ...
                int rst = mySeqListener2.StartListen(address);
                //if (0 == rst) NLogger.Debug("Tester:" + TesterID + "-Chamber:" + chamberNo + "---Listener Started!" + "---Address:" + address);
                //else NLogger.Debug("Tester:" + TesterID + "-Chamber:" + chamberNo + "---Listener Start Failed !!!" + "---Address:" + address);
                return rst;
            }
        ...
        public int StopSeqListener(int chamberNo)
        {
            ...
            {
                //myListener1.SetKeepRun(false);
                mySeqListener1.StopListen();
                return 0;
            }
            else if (2 == chamberNo)
            {
                //myListener2.SetKeepRun(false);
                mySeqListener2.StopListen();
                return 0;
            }
            else
            {
        ...
        public int StartSMListener(int chamberNo)
        {
            lock (objLockStartSM)
            {
                if (1 == chamberNo)
                {
                    ...
                    int rst = mySMListener1.StartListen(address);
                ...
                else if (2 == chamberNo)
                {
                    ...
                    int rst = mySMListener2.StartListen(address);
        ...
        public int StopSMListener(int chamberNo)
        {
            if (1 == chamberNo)
            {
                mySMListener1.StopTest();
                return 0;
            }
            else if (2 == chamberNo)
            {
                mySMListener2.StopTest();
                return 0;
            }
            else
            {
        ...
        private void ReprotError2ALC(string testerId, string chamberId, int errCode, string errStr)
        {
            using(ErrorEventArgs arg = new ErrorEventArgs())
            {
                ...
                if (this.event_2ALC_PopupError != null)
                {
                    //event_2ALC_PopupError.Invoke(sender, errStr);
                    event_2ALC_PopupError.BeginInvoke(testerId, chamberId, arg, null, null);
                }
            }
        }
        ...
        private void SendTestEndEvent(string chamberName, string dutSn, SeqEndArgs args)
        {
            ...
            if (this.event_2ALC_TestResult != null)
            {
                //event_2ALC_TestResult.Invoke(TesterID, chamberNo, isTestOk);
                event_2ALC_TestResult.BeginInvoke(TesterID, chamberName, dutSn, isTestOk, null, null);
            }
        }
        ...
        {
            if (null != event_2ALC_ChamberEnableChanged)
            {
                event_2ALC_ChamberEnableChanged.BeginInvoke(TesterID, chamberName, isEnable, null, null);
            }
        }
