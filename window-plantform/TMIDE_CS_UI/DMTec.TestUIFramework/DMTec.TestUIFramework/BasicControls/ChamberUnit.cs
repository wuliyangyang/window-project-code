...
namespace DMTec.TestUIFramework.BasicControls
{
    ...
    public partial class ChamberUnit : UserControl
    {
        ...
        public void BindSeqListenerEvents(ref SequencerListener listener)
        {
            ...
            //listener.event_LogInfo  += OnSeqLogInfo;
            //listener.event_LogWarn  += OnSeqLogWarn;
            //listener.event_LogError += OnSeqLogError;
            //listener.event_uencerMessage += OnSeqOriginalMsgHandle;   //Bind Msg Received Event
            ...
            listener.event_FctHeartbeat += OnSeqHeartbeatHandle;
        ...
        public void UnbindSeqListenerEvents(ref SequencerListener listener)
        {
            ...
            //listener.event_LogWarn -= OnSeqLogWarn;
            //listener.event_LogError -= OnSeqLogError;
            //listener.event_uencerMessage -= OnSeqOriginalMsgHandle;
            //Bind Seq Events
            listener.event_SeqStart -= OnSeqStartHandle;
            listener.event_SeqEnd -= OnSeqEndHandle;
            listener.event_ItemStart -= OnSeqItemStartHandle;
        ...
        public void BindNetEvents(ref SequencerListener listener, ref SeqRequester requester)
        {
            ...
            requester.event_ItemList += myItemsList.ItemListHandle;
        }
        ...
        public void BindEngineListenerEvents(ref EngineConnector egnc)
        {
            ...
            //Component msg to ui display
            egnc.event_LogInfo += OnSeqLogInfo;
            egnc.event_LogWarn += OnSeqLogWarn;
            egnc.event_LogError += OnSeqLogError;
