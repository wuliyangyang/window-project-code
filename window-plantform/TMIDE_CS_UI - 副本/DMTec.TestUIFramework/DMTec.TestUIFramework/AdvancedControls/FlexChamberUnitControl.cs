...
namespace DMTec.TestUIFramework.AdvancedControls
{
    ...
    public partial class FlexChamberUnitControl : UserControl
    {
        ...
        public event SequenceEndHandler event_SeqEnd;
        ...
        {
            if (null != event_SeqEnd)
            {
                event_SeqEnd.Invoke(DutSN, (Consts.TESTEND_PASS_STRING == isPass) ? true : false);
            }
        }
