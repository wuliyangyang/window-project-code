...
function FixtureState:CreateFixture(ctx, in_pipe, args)
	...
	self.fixtureObj = fixture:new(ctx, zmqConf.get_addr("FIXTURE_CTRL_SUB_ADDR", "FIXTURE_CTRL_PUB", args.module, args.slots, 0),
	    zmqConf.get_addr("FIXTURE_CTRL_REQ_ADDR", "FIXTURE_CTRL_PORT", args.module, args.slots, 0)
	)
...
function FixtureState:InitSM()
	...
	self:add_transition(FixtureState.STATE.UNLOAD, FixtureState.STATE.IDLE, FixtureState.EVENT.REMOVED, nil)
