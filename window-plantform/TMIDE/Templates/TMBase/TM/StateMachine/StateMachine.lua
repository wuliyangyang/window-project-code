...
-- Start HB thread
local watchdog_thread, pipe = require("HB").HeartBeat(ctx, zmqConf.get_addr("STATEMACHINE_HEARTBEAT_ADDR", "SM_PUB", args.module, args.slots, 0)) 
smPipe.pipe = pipe
